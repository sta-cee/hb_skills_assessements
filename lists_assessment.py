...
def foods_in_common(foods1, foods2):
    ...
    **NOTE**: for this problem, you're welcome to use any of the
    ...
    for item in foods1 and foods2:
        if item in foods1 and item in foods2:
...
def largest_n_items(items, n):
    ...
    if n == 0:
        ...
        # found reverse here: https://stackoverflow.com/questions/4183506/python-list-sort-in-descending-order
        items.sort(reverse=True)
        for item in range(n):
            largest_int_list.append(items[item])
    return sorted(largest_int_list)
